...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(wx.NewId(), "Realizar Backup", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Restaurar de Backup", "", wx.ITEM_NORMAL)
        self.frame_menubar.Append(wxglade_tmp_menu, "Archivo")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu_sub = wx.Menu()
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Disponibles", "", wx.ITEM_CHECK)
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Condicionales", "", wx.ITEM_CHECK)
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Vendidas", "", wx.ITEM_CHECK)
        wxglade_tmp_menu.AppendMenu(wx.NewId(), "Prendas", wxglade_tmp_menu_sub, "")
        wxglade_tmp_menu_sub = wx.Menu()
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Al dia", "", wx.ITEM_CHECK)
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Tardios", "", wx.ITEM_CHECK)
        wxglade_tmp_menu_sub.Append(wx.NewId(), "Morosos", "", wx.ITEM_CHECK)
        wxglade_tmp_menu.AppendMenu(wx.NewId(), "Clientes", wxglade_tmp_menu_sub, "")
        self.frame_menubar.Append(wxglade_tmp_menu, "Ver")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.NewId(), "Vaciar Carrito", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Borrar todo ", "", wx.ITEM_NORMAL)
        self.frame_menubar.Append(wxglade_tmp_menu, "Herramientas")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.NewId(), "Lista de correos", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Lista de correos morosos", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Lista de telefonos", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Lista de telefonos de morosos", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), u"Lista de cumpleaños del mes", "", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "Totales de ganancias y deudas", "", wx.ITEM_NORMAL)
